import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getRequestProtocol, getRequestHost, getQuery as getQuery$1, setHeader, getHeader, getRouterParam, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file://E:/alumicolt-v3/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, withBase, withTrailingSlash, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file://E:/alumicolt-v3/node_modules/ufo/dist/index.mjs';
import destr from 'file://E:/alumicolt-v3/node_modules/destr/dist/index.mjs';
...
import { toValue } from 'file://E:/alumicolt-v3/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1, basename, isAbsolute } from 'file://E:/alumicolt-v3/node_modules/pathe/dist/index.mjs';
...
import { consola, createConsola } from 'file://E:/alumicolt-v3/node_modules/consola/dist/index.mjs';
...
import file_58_47_47_47E_58_47alumicolt_45v3_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file:///E:/alumicolt-v3/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import unstorage_47drivers_47fs_45lite from 'file://E:/alumicolt-v3/node_modules/unstorage/drivers/fs-lite.mjs';
...
storage.mount('internal:nuxt:prerender', file_58_47_47_47E_58_47alumicolt_45v3_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///E:/alumicolt-v3/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"E:/alumicolt-v3/node_modules/.cache/nuxt/.nuxt/cache/nitro/prerender"}));
...
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/alumicolt-v3/node_modules/.cache/nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/alumicolt-v3/node_modules/.cache/nuxt/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "28590c45-f0b2-47e1-81a1-d1c0cccaa230",
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2026-03-04T20:48:41.018Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
...
const _lazy_9rnkBZ = () => import('./renderer.mjs').then(function (n) { return n.r; });
