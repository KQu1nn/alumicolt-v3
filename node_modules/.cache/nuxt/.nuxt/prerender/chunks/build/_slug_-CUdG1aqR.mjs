...
import { computed, mergeProps, withCtx, createTextVNode, unref, useSSRContext } from 'file://E:/alumicolt-v3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'file://E:/alumicolt-v3/node_modules/vue/server-renderer/index.mjs';
...
const fachadaGlazing = "" + __buildAssetsURL("fachada-glazing.BGYcxXOK.png");
const ripados = "" + __buildAssetsURL("ripados.CfHui656.png");
const gradis = "" + __buildAssetsURL("gradis.qKAGArTO.jpg");
const portasEntrada = "" + __buildAssetsURL("portas-de-entrada._6jGSchr.avif");
const box = "" + __buildAssetsURL("box.Di98o2pD.webp");
...
O processo produtivo inclui análise de projeto, fabricação em ambiente controlado e instalação técnica especializada. O resultado é uma esquadria que se integra perfeitamente à arquitetura, com alto padrão de acabamento e desempenho comprovado ao longo do tempo.`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="w-full px-6 md:px-50 py-10 md:py-10"><div class="max-w-5xl mx-auto flex flex-col gap-6"><nav class="flex items-center gap-2 text-gray-500 text-sm">`);
      ...
      _push(`<span class="text-blue-600 font-semibold">${ssrInterpolate(unref(product).title)}</span></nav><div class="flex items-center gap-2"><span class="w-10 h-[2px] bg-blue-600"></span><p class="text-blue-600 font-bold tracking-widest text-sm uppercase">Detalhes do Produto</p></div><div class="flex flex-col gap-3"><h1 class="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">${ssrInterpolate(unref(product).title)}</h1><div class="flex flex-col gap-3"><p class="text-gray-600 leading-relaxed text-base md:text-[17px]">${ssrInterpolate(unref(product).shortDescription)}</p></div></div></div></section><section class="flex-1 max-w-5xl mx-auto px-6 md:px-12 py-5 md:py-10 flex flex-col gap-12"><div class="rounded-2xl overflow-hidden shadow-md bg-white border border-gray-200 flex items-center justify-center p-4"><div class="w-full bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden"><img${ssrRenderAttr("src", unref(product).image)}${ssrRenderAttr("alt", `Imagem de ${unref(product).title}`)} class="max-h-[450px] w-auto object-contain transition-transform duration-300 hover:scale-[1.02]"></div></div><div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col gap-4"><h2 class="text-2xl font-bold text-blue-700">Sobre o produto</h2><div class="flex flex-col gap-3"><!--[-->`);
      ssrRenderList(unref(product).description.split("\n\n").filter((p) => p.trim()), (paragraph, index) => {
        _push(`<p class="text-gray-600 leading-relaxed text-base md:text-[17px]">${ssrInterpolate(paragraph.trim())}</p>`);
      });
      _push(`<!--]--></div></div><div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm"><h2 class="text-2xl font-bold text-blue-700 mb-6">Especificações Técnicas</h2><div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8"><!--[-->`);
      ssrRenderList(unref(product).specs, (spec) => {
        _push(`<div class="flex flex-col bg-gray-50 rounded-xl px-5 py-4 border border-gray-100 hover:border-blue-200 transition"><span class="text-gray-500 text-sm">${ssrInterpolate(spec.label)}</span><span class="text-gray-900 font-semibold text-base">${ssrInterpolate(spec.value)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="flex flex-col sm:flex-row gap-4 mt-6">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      _push(`<a${ssrRenderAttr("href", lojaUrl)} target="_blank" class="flex-1 text-center bg-blue-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-blue-700 transition shadow-md"> Ver na Loja </a></div></section>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/produtos/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-CUdG1aqR.mjs.map
