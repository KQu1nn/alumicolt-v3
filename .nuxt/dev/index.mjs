...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file://E:/alumicolt-v3/node_modules/ufo/dist/index.mjs';
...
import defu, { defuFn, defu as defu$1, createDefu } from 'file://E:/alumicolt-v3/node_modules/defu/dist/defu.mjs';
...
import { toValue, isVNode, isRef } from 'file://E:/alumicolt-v3/node_modules/vue/index.mjs';
...
import consola, { createConsola, consola as consola$1 } from 'file://E:/alumicolt-v3/node_modules/consola/dist/index.mjs';
...
import devalue from 'file://E:/alumicolt-v3/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
import { dirname as dirname$1, resolve as resolve$2, basename, isAbsolute } from 'file://E:/alumicolt-v3/node_modules/pathe/dist/index.mjs';
...
import { XMLParser } from 'file://E:/alumicolt-v3/node_modules/fast-xml-parser/src/fxp.js';
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2026-03-05T05:12:28.289Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
...
const _5ROzRg6JDGwpkurQ4r8_dMNHB7XJGr2LPEPDdTKUHuA = defineNitroPlugin(async (nitroApp) => {
...
_5ROzRg6JDGwpkurQ4r8_dMNHB7XJGr2LPEPDdTKUHuA,
...
const _ASiIS3 = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _7fb4nX = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const __M5Uww = defineEventHandler(async (e) => {
  const collections = [];
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://E:/alumicolt-v3/node_modules/fast-xml-parser/src/fxp.js');
...
const _8qqgXe = defineEventHandler(async (e) => {
...
const _1ThXVR = defineEventHandler(async (e) => {
...
const _HUjPio = defineEventHandler(sitemapXmlEventHandler);
...
const handlers = [
  ...
  { route: '', handler: _ASiIS3, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _7fb4nX, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: __M5Uww, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _8qqgXe, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _1ThXVR, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _HUjPio, lazy: false, middleware: false, method: undefined },
