...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, getRouterParam, setHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/@vue/shared/dist/shared.cjs.js';
import { MercadoPagoConfig, Preference } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/mercadopago/dist/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/destr/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabase": {
      ...
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNqdnduaWx0d2hxYnJpeXplYnl1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc2MDgzMzUsImV4cCI6MjA4MzE4NDMzNX0.0vkre3zFMuZLV1naHNJRRacgO0lCsVC-kvWTpOLhNDo",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-sjvwniltwhqbriyzebyu-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
  ...
  "mercadopagoAccessToken": "APP_USR-8004153087910861-010913-f0482e5f5d3bff16a1b6972650e3276d-1673299945",
  "icon": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/yanso/OneDrive/Área de Trabalho/Alumicolt-v2-main/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const __7vid9AwEQ56LBb2s93fZvkyrqjh3FnW91AvZdtdDOQ = (function(nitro) {
...
const _CnrMmyFYg2n502OPaWIKBz9nrix743wNpI0rL6_X6vs = (nitroApp) => {
...
const plugins = [
  __7vid9AwEQ56LBb2s93fZvkyrqjh3FnW91AvZdtdDOQ,
_CnrMmyFYg2n502OPaWIKBz9nrix743wNpI0rL6_X6vs
];
...
const _cW2rdq = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _k3AYys = defineCachedEventHandler(async (event) => {
...
const _XtdlMb = eventHandler(async (event) => {
  ...
  return await import('file://C:/Users/yanso/OneDrive/%C3%81rea%20de%20Trabalho/Alumicolt-v2-main/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _HbMKZX = eventHandler(async (event) => {
...
const _lazy_uvZkjH = () => Promise.resolve().then(function () { return createPreference_post$1; });
const _lazy_OE7Wo9 = () => Promise.resolve().then(function () { return mercadopago_post$1; });
const _lazy_u1Znpz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _cW2rdq, lazy: false, middleware: true, method: undefined },
  { route: '/api/create-preference', handler: _lazy_uvZkjH, lazy: true, middleware: false, method: "post" },
  { route: '/api/webhook/mercadopago', handler: _lazy_OE7Wo9, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_u1Znpz, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _k3AYys, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _XtdlMb, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _XtdlMb, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _HbMKZX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _HbMKZX, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_u1Znpz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_u1Znpz, lazy: true, middleware: false, method: undefined }
];
...
const createPreference_post = defineEventHandler(async (event) => {
  var _a, _b, _c, _d;
  const config = useRuntimeConfig();
  ...
  try {
    ...
    if (paymentMethod === "pix") {
      ...
      body.expires_at = new Date(Date.now() + 30 * 60 * 1e3);
      const result = await preference.create({ body });
      return {
        qrCodeBase64: ((_b = (_a = result.point_of_interaction) == null ? void 0 : _a.transaction_data) == null ? void 0 : _b.qr_code_base64) || null,
        qrCode: ((_d = (_c = result.point_of_interaction) == null ? void 0 : _c.transaction_data) == null ? void 0 : _d.qr_code) || null
      };
      console.log("Prefer\xEAncia PIX criada:", result);
    } else {
    ...
    throw createError({ statusCode: 500, message: error.message || "Erro ao criar prefer\xEAncia" });
  }
});

const createPreference_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: createPreference_post
}, Symbol.toStringTag, { value: 'Module' }));

const mercadopago_post = defineEventHandler(async (event) => {
...
const mercadopago_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: mercadopago_post
}, Symbol.toStringTag, { value: 'Module' }));
